...
export function middleware() {
  ...
  // Next.js App Router injects small inline flight/hydration scripts; script-src 'self' alone blocks
  // them and the page renders without a working client — buttons/forms do nothing.
